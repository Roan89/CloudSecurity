...
public class MyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   out.println("<html>");
	  out.println("<head><h1>Student Details</h1></head>");
	  out.println("<body>");
	  out.println("<div style='margin-left:150px'>");
	 out.println("<p>");
	 out.println("<table style='background-color:beige;margin-left:340px;'>");
	...
	out.println("</div>");
	out.println("<div style='margin-left:340px'><a href='index.jsp'>Add More</a></div>");
	out.println("</body>");
	out.println("</html>");
	}
